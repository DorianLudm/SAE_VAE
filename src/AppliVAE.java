...
public class AppliVAE extends Application{
    ...
    public void modeObjets(int idVe, String nomO, String desc, String debutve, String finve, String prixbase, String montantAct){
        ...
        if(montantAct.equals("")){montantAct = prixbase;}
        double montantMini = (Integer.parseInt(montantAct) + 0.1 * Integer.parseInt(prixbase));
        Label surenchere = new Label("Surenchère minimal : " + montantMini);
        ...
        this.prixPropose = new TextField();
        this.prixPropose.setStyle("-fx-background-color: #"+this.couleur+";");
        this.prixPropose.setFont(Font.font("Ubuntu", FontWeight.BOLD, 20));
        encherir1.getChildren().addAll(encherirL, this.prixPropose);
        ...
        encherirB.setOnAction(new ControleurEncherir(this, this.modele, montantMini,  this.prixPropose.getText(), idVe));
    ...
    public Alert prixTropBasPopup(){
        Alert alert = new Alert(Alert.AlertType.INFORMATION, "Le prix que vous avez proposé est trop bas!\nVeillez à enchérir au moins le prix minimal");  
        alert.setHeaderText("Erreur Enchérissment");
        alert.setTitle("VAE");     
        return alert;
    }
