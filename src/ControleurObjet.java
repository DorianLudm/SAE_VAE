...
public class ControleurObjet implements EventHandler<ActionEvent> {
    ...
    public void handle(ActionEvent actionEvent){
        ...
        try{
            ...
            this.vueVAE.modeObjets(this.idv, ob.getNom(),ob.getDescription(),this.modele.getDebutVente(ob),this.modele.getFinVente(ob),this.modele.getPrixBase(ob),this.modele.getMontantObjet(ob));
